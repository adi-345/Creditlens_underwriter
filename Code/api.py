...
# 1. DIAGNOSTIC WRAPPER: Force the server to print the hidden error
try:
    from fastapi import FastAPI, UploadFile, File
    import os
    import shutil
    ...
    print("\n" + "="*60)
    print("🚨 CRITICAL BOOT ERROR DETECTED IN IMPORTS 🚨")
...
try:
    ...
    print("\n" + "="*60)
    print("🚨 CRITICAL BOOT ERROR DETECTED IN FASTAPI INITIALIZATION 🚨")
    traceback.print_exc(file=sys.stdout)
    print("="*60 + "\n")
    raise e
